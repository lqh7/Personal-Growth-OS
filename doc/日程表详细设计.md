...
```scss
$color-priority-high: #ef4444;    // 红色 (4-5)
$color-priority-medium: #3b82f6;  // 蓝色 (2-3)
$color-priority-low: #10b981;     // 绿色 (0-1)
$color-aggregation: #e5e7eb;      // 聚合灰
```
